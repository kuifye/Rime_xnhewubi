...
local function select_character(key, env)
   ...
   local first_key = config:get_string('key_binder/select_first_character') or 'comma'
   local last_key = config:get_string('key_binder/select_last_character') or 'period'
